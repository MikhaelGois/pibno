...
- Interface visual completa para gerenciar posts
      - **Acesso ao painel:**
         - Use uma conta administrativa criada no Firebase Authentication ou outra conta segura; não exponha senhas padrão.
...
2. **Fazer login:**
   - Faça login com sua conta administrativa configurada (não use senhas padrão em ambientes públicos).
