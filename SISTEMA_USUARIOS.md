...
### Regras de Exclusão:
- ❌ Não pode excluir o usuário padrão `admin`
...
2. Cole: 
```javascript
localStorage.setItem('pibno_users', '[{"id":1,"username":"admin","password":"pibno2025","name":"Administrador","role":"admin"}]')
```
3. Recarregue a página
4. Entre com: admin / pibno2025
