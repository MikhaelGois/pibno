...
1. **Criar usuário no Authentication:**
  ...
  - E-mail: `you@yourdomain.com` (use your admin email)
  - Senha: escolha uma senha forte (não inclua senhas padrão em código público)
   - Clique em **Adicionar usuário**
...
2. Registre-se com (use valores reais e seguros):
  - Nome: Administrador
  - Usuário: admin
