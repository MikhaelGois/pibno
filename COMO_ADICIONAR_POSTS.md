...
### Acesso ao Painel:
Use uma conta administrativa criada no Firebase Authentication ou por meio do painel de administração configurado. Não inclua credenciais padrão em instalações públicas.
